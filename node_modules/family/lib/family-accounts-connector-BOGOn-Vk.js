import { getAddress, createWalletClient, custom, publicActions, SwitchChainError, numberToHex, UserRejectedRequestError, withRetry, withTimeout, ResourceUnavailableRpcError } from 'viem';
...
const initPostRobot = async () => {
    postRobot = await import('./index-Cs-onntv.js').then(function (n) { return n.i; });
};
const getPostRobot = () => {
...
const createFamilyAccountsClient = async () => {
    ...
    const client = createWalletClient({
        ...
        transport: custom(new EthereumProvider()),
    })
...
export { CommunicationTypes as C, EthereumProviderConnectionTimeoutError as E, FamilyAccountsSdk as F, SessionStatus as S, SessionCreateResult as a, EthereumProvider as b, createFamilyAccountsClient as c, familyAccountsConnector as d, familyAccountsCustomActions as f, invariant as i, logger as l, production as p };

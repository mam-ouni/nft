...
Cette section présente les principales commandes utilisées pour **compiler, déployer et interagir avec les Smart Contracts** dans l’environnement **Foundry**.
Les tests sont réalisés sur une **blockchain locale simulée avec Anvil**.
